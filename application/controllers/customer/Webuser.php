...
class Webuser extends CI_Controller {
    ...
    public function user_dashboard()
    {
        ...
        // $data['counterData'] = $this->user_model->get_all_records_task_priority_by_current_month($filterArr,$this->session->userdata('u_user_id'));	
       	
		// $data['expenseYearData'] = $this->user_model->get_all_expense_by_year($filterArr,$this->session->userdata('u_user_id'));
