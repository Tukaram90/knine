  ...
  <aside class="main-sidebar">   
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if($active == 'kennelType' || $active == 'addKennelType' || $active == 'expenceCategoryList' || $active == 'addExpenceCategory'){ echo 'active'; }else{echo"";}?> menu-open" >
          <a href="#">
          ...
          <ul class="treeview-menu" style="">
            <li class="<?php if($active == 'kennelType'){ echo 'active'; }?>">
              <a href="<?php echo base_url();?>mastersetting/kennel_type_list"><i class="fa fa-circle-o"></i> Dog Breeds</a>
            </li>
            <li class="<?php if($active == 'expenceCategoryList'){ echo 'active'; }?>">
              <a href="<?php echo base_url();?>mastersetting/expence_category"><i class="fa fa-circle-o"></i> Expence Categorys</a>
            </li>             
          </ul>
        </li>
