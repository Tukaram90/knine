...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <form role="form" name="showForm" action="<?php echo base_url(); ?>edit-show/<?= $showInfo['id'] ?>"  method="post" enctype="multipart/form-data">
              <div class="box-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <select name="dog_id" id="" class="form-control">
                                    ...
                                    <?php foreach($dogListByUserDetails as $dog){ ?>
                                        <option value="<?= $dog['dog_id'] ?>" <?php if(!empty($showInfo) && isset($showInfo)){ if($dog['dog_id']==$showInfo['dog_id']){echo"selected";} } ?>><?= $dog['dog_name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <?php if(isset($showInfo) && !empty($showInfo)){ $i=0; $section =0;?>
                        <?php foreach($showInfo['showDetails'] as $details) { $i++;  ?>
                        <div class="panel-group customRow<?= $i ?>" id="accordion">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?= $i ?>">
                                        SECTION <?= $i.'.'.'1' ?> - GENERAL SHOW DETAILS
                                    </a>
                                </h4>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="clubname[]" id="clubname"  class="form-control" placeholder="Club name" value="<?= $details['club_name'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Show location</label>
                                                    <input type="text" name="showlocation[]" id="showLocation"  class="form-control" placeholder="Show location" value="<?= $details['show_location'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Show Date</label>
                                                    <input type="date" name="show_date[]" id="showDate"  class="form-control" placeholder="Show Date" value="<?= $details['show_date'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Entry Fee</label>
                                                    <input type="text" name="fee[]" id="Fee"  class="form-control" placeholder="Entry Fee" value="<?= $details['entry_fee'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Show Photographer</label>
                                                    <input type="text" name="photographer[]" id="photographer"  class="form-control" placeholder="Photographer" value="<?= $details['photographer'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Photographer contact info</label>
                                                    <input type="text" name="photographer_contact[]" id="photographer_contact"  class="form-control" placeholder="Photographer contact" value="<?= $details['photographer_contact'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Show Superintendent</label>
                                                    <input type="text" name="show_superintendent[]" id="show_superintendent"  class="form-control" placeholder="Show Superintendent" value="<?= $details['superintendent'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Show Chair</label>
                                                    <input type="text" name="show_chair[]" id="show_chair"  class="form-control" placeholder="Show Chair" value="<?= $details['show_chair'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Show Chair contact info</label>
                                                    <input type="text" name="chair_contact_info[]" id="chair_contact_info"  class="form-control" placeholder="Show Chair contact info" value="<?= $details['show_chair_contact'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Breed Judge</label>
                                                    <input type="text" name="breed_judge[]" id="breed_judge"  class="form-control" placeholder="Breed Judge" value="<?= $details['breed_judge'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="breed_judge_provisional[]" id="" class="form-control">
                                                        ...
                                                        <option value="yes" <?php if($details['breed_judge_provisinal']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['breed_judge_provisinal']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="group_judge[]" id="group_judge"  class="form-control" placeholder="Group Judge" value="<?= $details['group_judge'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="group_judge_provisional[]" id="" class="form-control">
                                                        <option value="">Provisional</option>
                                                        <option value="yes" <?php if($details['group_judge_provosional']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['group_judge_provosional']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nohs_judge[]" id="nohs_judge"  class="form-control" placeholder="NOHS Group Judge" value="<?= $details['nohs_group_judge'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nohs_judge_provisional[]" id="" class="form-control">
                                                        <option value="">Provisional</option>
                                                        <option value="yes" <?php if($details['nohs_group_judge_provosinal']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['nohs_group_judge_provosinal']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="best_judge[]" id="best_judge"  class="form-control" value="<?= $details['best_show_judge'] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">NOHS Best in Show Judge</label>
                                                    <input type="text" name="nohs_best_judge[]" id="nohs_best_judge"  class="form-control" value="<?= $details['nohs_best_show_judge'] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Comments on Show grounds</label>
                                                    <textarea class="form-control" rows="3" name="comments_grounds[]" id="comments_grounds" placeholder="Comments"><?= $details['comments_show_grounds'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <h4 class="panel-title">
                                    ...
                                    SECTION <?= $i.'.'.'2' ?> - BREED ENTRY AND AWARDS
                                    </a>
                                </h4>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dog_handled[]" id="dog_handled"  class="form-control" placeholder="Dog Handled by" value="<?= $details['dog_handledby'] ?>"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="class_entered[]" id="class_entered" class="form-control select2" style="width: 100%;">
                                                    ...
                                                    <?php foreach($classEntredArr as $option){ ?>
                                                        <option value="<?= $option ?>" <?php if($details['class_entered']==$option){echo"selected";} ?>><?= $option ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Entry Fee</label>
                                                <input type="text" name="handled_entry_fee[]" id="handled_entry_fee"  class="form-control" placeholder="Fee" value="<?= $details['entry_fee2section'] ?>"/>
                                            </div>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="nmbr_class_dog[]" id="nmbr_class_dog"  class="form-control" placeholder="Number of Class dogs" value="<?= $details['number_ofclass_dog'] ?>" />
                                        </div>
                                        <div class="col-md-3">
                                            <label class="control-label">Number of class bitches</label>
                                            <input type="text" name="nmbr_class_bitches[]" id="nmbr_class_bitches"  class="form-control" placeholder="Number of Class bitches" value="<?= $details['number_of_class_bitches'] ?>"/>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="control-label">Non-regular entries</label>
                                            <input type="text" name="non_regular_entry[]" id="non_regular_entry"  class="form-control" placeholder="Number of non-regular entries" value="<?= $details['non_regular_entry'] ?>"/>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="control-label">Number of BOB entries</label>
                                            <input type="text" name="number_bob_entry[]" id="number_bob_entry"  class="form-control" placeholder="Number of Class dogs" value="<?= $details['bob_entries'] ?>"/>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-md-6">
                                            <label class="control-label">Total entry showing in the Breed</label>
                                            <input type="text" name="total_entry[]" id="total_entry"  class="form-control" placeholder="Total entry showing in the Breed" value="<?= $details['total_entry_showing_breed'] ?>" />
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="major_entry[]" id="" class="form-control">
                                                    ...
                                                    <option value="yes" <?php if($details['major_entry']=='yes'){echo"selected";}?>>Yes</option>
                                                    <option value="no" <?php if($details['major_entry']=='no'){echo"selected";}?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="first_award[]" id="1st_award" class="form-control select2" style="width: 100%;">
                                                    ...
                                                    <?php foreach($awardlistArr as $option){ ?>
                                                        <option value="<?= $option ?>" <?php if($details['first_award_received']==$option){echo"selected";} ?>><?= $option ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="second_award[]" id="2nd_award" class="form-control select2" style="width: 100%;">
                                                    <option value=""></option>
                                                    <?php foreach($awardlistArr as $option){ ?>
                                                        <option value="<?= $option ?>" <?php if($details['second_award_recived']==$option){echo"selected";} ?>><?= $option ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="third_award[]" id="3rd_award[]" class="form-control select2" style="width: 100%;">
                                                    <option value=""></option>
                                                    <?php foreach($awardlistArr as $option){ ?>
                                                        <option value="<?= $option ?>" <?php if($details['third_award_recived']==$option){echo"selected";} ?>><?= $option ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="fourth_award[]" id="4th_award[]" class="form-control select2" style="width: 100%;">
                                                    <option value=""></option>
                                                    <?php foreach($awardlistArr as $option){ ?>
                                                        <option value="<?= $option ?>" <?php if($details['fourth_award_recived']==$option){echo"selected";} ?>><?= $option ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>                                                    
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="group_placement[]" id="group_placement" class="form-control">
                                                        ...
                                                        <?php foreach($oneTroughFourArr as $option){ ?>
                                                            <option value="<?= $option ?>" <?php if($details['group_placement']==$option){echo"selected";} ?>><?= $option ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="group_plcement_points[]" id="group_plcement_points"  class="form-control" placeholder="Number of group points" value="<?= $details['group_points'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nohs_group_placement[]" id="nohs_group_placement" class="form-control">
                                                        <option value=""></option>
                                                        <?php foreach($oneTroughFourArr as $option){ ?>
                                                            <option value="<?= $option ?>" <?php if($details['nohs_group_placement']==$option){echo"selected";} ?>><?= $option ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Number of group points</label>
                                                    <input type="text" name="nohs_group_points[]" id="nohs_group_points"  class="form-control" placeholder="Number of group points" value="<?= $details['nohs_group_points'] ?>"/>
                                                </div>
                                            </div>
                                        </div>    
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="best_in_show[]" id="best_in_show" class="form-control">
                                                        <option value=""></option>
                                                        <option value="yes"  <?php if($details['best_show_in3section']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no"  <?php if($details['best_show_in3section']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bst_show_entry[]" id="show_entry"  class="form-control" placeholder="Best in Show" value="<?= $details['best_show_entry'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="reserve_bst_show[]" id="" class="form-control">
                                                        <option value=""></option>
                                                        <option value="yes" <?php if($details['reserved_best_show']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['reserved_best_show']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div> 
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nohs_best_in_show[]" id="nohs_best_in_show" class="form-control">
                                                        <option value=""></option>
                                                        <option value="yes" <?php if($details['nohs_best_show_3section']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['nohs_best_show_3section']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Show entry</label>
                                                    <input type="text" name="nohs_show_entry[]" id="nohs_show_entry"  class="form-control" placeholder="Best in Show" value="<?= $details['nohs_show_entry_3section'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nohs_reserve_bst_show[]" id="" class="form-control">
                                                        <option value=""></option>
                                                        <option value="yes" <?php if($details['nohs_reserved_bst_show']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['nohs_reserved_bst_show']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">                                        
                                                    ...
                                                    <select name="non_regular_group[]" id="non_regular_group" class="form-control">
                                                        <option value=""></option>
                                                         <?php foreach($nonRegularGroupArr as $option){ ?>
                                                            <option value="<?= $option ?>" <?php if($details['non_regular_group_3section']==$option){echo"selected";} ?>><?= $option ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Group Judge</label>
                                                    <input type="text" name="group_judge[]" id="group_judge"  class="form-control" placeholder="Best in Show" value="<?= $details['group_judge_3section'] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="group_placement_3section[]" id="group_placement_3section" class="form-control">
                                                        <option value=""></option>
                                                        <?php foreach($oneTroughFourArr as $option){ ?>
                                                            <option value="<?= $option ?>" <?php if($details['group_placement_3section']==$option){echo"selected";} ?>><?= $option ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="non_regular_best_in_show_3sec[]" id="non_regular_best_in_show_3sec" class="form-control">
                                                        <option value=""></option>
                                                        <option value="yes" <?php if($details['non_regular_best_show_3section']=='yes'){echo"selected";}?>>Yes</option>
                                                        <option value="no" <?php if($details['non_regular_best_show_3section']=='no'){echo"selected";}?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="non_regular_best_show_judge_3sec[]" id="non_regular_best_show_judge_3sec"  class="form-control" placeholder="Best in Show" value="<?= $details['non_regular_best_show_judge_3section'] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="comments_show_grounds_judging3section[]" id="" placeholder="Comments on Show grounds and Judging"><?= $details['commenst_show_grounds_judging'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>                       
                                    </div>
                        ...
                        <input type="hidden" name="showDetailsId[]" class="form-control"  value="<?= $details['id']  ?>">
                    <?php } }?>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary"  name="edit-show-form">Update</button>
                    <a href="<?php echo base_url()?>delete-show/<?php echo $showInfo['id']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                    <a href="<?php echo base_url()?>shows-list" class="btn btn-info" >Return</a>
                </div>
            </form>
        </div>
            </div>
