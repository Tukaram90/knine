...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Getting Vaccination List</li>
      </ol>
    </section>  
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php if(!empty($vaccinationDetails)): ?>
                      <?php $i=1; foreach($vaccinationDetails as $row): ?>
                        <tr> 
                          <td><?= $i ?></td>
                          ...
                          <td><?= date("Y-m-d",strtotime($row['next_appointment']));  ?></td> 
