...
<html>
   <head>
      ...
      <link href="<?php echo base_url(); ?>webasset/css/bootstrap.css" rel="stylesheet" type="text/css">
      <!-- Icon fonts -->
      <link href="<?php echo base_url(); ?>webasset/fonts/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
      <link href="<?php echo base_url(); ?>webasset/fonts/flaticons/flaticon.css" rel="stylesheet" type="text/css">
      <link href="<?php echo base_url(); ?>webasset/fonts/glyphicons/bootstrap-glyphicons.css" rel="stylesheet" type="text/css">
     
      <link href="https://fonts.googleapis.com/css?family=Lato:400,800" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css?family=Baloo+Thambi" rel="stylesheet">
      <!-- Style CSS -->
      <link href="<?php echo base_url(); ?>webasset/css/style.css" rel="stylesheet">
      <!-- Plugins CSS -->
      <link rel="stylesheet" href="<?php echo base_url(); ?>webasset/css/plugins.css">
      <!-- Color Style CSS -->
      <link href="<?php echo base_url(); ?>webasset/styles/maincolors.css" rel="stylesheet">
	    <!-- LayerSlider CSS -->
      <link rel="stylesheet" href="<?php echo base_url(); ?>webasset/vendor/layerslider/css/layerslider.css">
      <link rel="stylesheet" href="<?php echo base_url(); ?>webasset/vendor/layerslider/skins/outline/skin.css">
      <!-- Favicons-->
      ...
      <nav class="navbar navbar-custom navbar-fixed-top">
         <div class="container">
            ...
            <div class="navbar-header">
               ...
               <div class="navbar-brand navbar-brand-centered11 page-scroll pull-left">
                  <a href="#page-top">
                     <!-- logo  -->
                     <img src="<?php echo base_url(); ?>webasset/img/logo.jpg" class="img-responsive" id="weblogo" alt="" style="margin: -17px 1px 0px 0px;">
