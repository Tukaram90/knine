...
class User_model extends CI_Model 
{
    ...
    public function get_current_weekly_records($user_id){
        $sql = "SELECT expense_id,expense,amount,currency,expense_note,expense_added_date FROM dog_expense WHERE user_id = $user_id AND expense_added_date > DATE_SUB(NOW(), INTERVAL 1 WEEK)";
        $query = $this->db->query($sql);
        return $query->result_array();
    }
}