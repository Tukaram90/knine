var OrgChart = function(t, e) {
    //debugger
    var customClass = e.template+'SetBg';
    //alert(customClass)
    var r = this;
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible)
        ...
        0 != this.width() && 0 != this.height())) {
            ...
            this.manager.read(t, this.width(), this.height(), n, e, r, (function(n) {
                if (!a.notifierUI.show(n.notif) && (!1 !== a.config.lazyLoading || !0 !== t || e === OrgChart.action.exporting)) {
                    e != OrgChart.action.exporting && (a.nodes = n.nodes,
                    ...
                    if (OrgChart.events.publish("render", [a, o]),
                    l = o.content,
                    n = o.res,
                    l += a.ui.lonely(a.config),
                    e !== OrgChart.action.exporting) {
                        e !== OrgChart.action.centerNode && e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update || (d = h),
                        ...
                        )) : !h || !a.response || h[0] == a.response.viewBox[0] && h[1] == a.response.viewBox[1] && h[2] == a.response.viewBox[2] && h[3] == a.response.viewBox[3] || e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update && e !== OrgChart.action.init ? 0 == C[0].length && (m || (i && i(),
                        OrgChart.events.publish("redraw", [a]),
...
OrgChart.prototype._get = function(t) {
    ...
    if ((this.config.groupDottedLines.length || this.config.dottedLines.length) && !OrgChart.isNEU(t) && "string" == typeof t && (-1 != t.indexOf("balkan_group_dotted_") || -1 != t.indexOf("balkan_dotted_"))) {
        ...
        if (t = t.substring(r + "_balkan_id_".length),
        e = this.__get(t))
            return e
    }
    return null
...
OrgChart.editUI.prototype.content = function(t, e, r, i, a) {
    ...
    OrgChart.isNEU(C) && (C = ""),
    b = OrgChart.isNEU(b) ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${b}"></img>`;
    var w = !e
      , k = e ? "display:none;" : ""
      , S = e || !s ? "display:none;" : ""
...
OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function(t, e, r) {
    ...
    if (n.draggable) {
        ...
        u.setAttribute("transform", "matrix(1,0,0,1," + (m + b.x) + "," + (C + b.y) + ")"),
        u.style.opacity = .7;
        var O = function(t, e) {
            if (null != t) {
            ...
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    ...
                    if (null != d) {
                        ...
                        for (var A = o.getNode(d), E = OrgChart.getStParentNodes(A), N = 0; N < E.length; N++) {
    ...
    if (this.config.enableDragDrop) {
        ...
        var m = function(t, e) {
          ...
          , b = function(e) {
            ...
            n.id == o || null == o)
                return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f]),
                h.removeChild(f),
    ...
    this.input.value == OrgChart.SEARCH_HELP_SYMBOL)
        ...
        t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${function() {
            for (var t = "", i = 0; i < e.lastSearch.length && !(i >= OrgChart.SEARCH_RESULT_LIMIT); i++) {
                ...
                var l = ""
                  , s = "";
                e.obj.config.searchDisplayField == a.__searchField ? l = a.__searchMarks : e.obj.config.searchDisplayField ? (l = a[e.obj.config.searchDisplayField],
                OrgChart.isNEU(l) && (l = ""),
...
OrgChart.manager._iterate = function(t, e, r, i, a, n, o, l, s, h, d, c) {
    ...
    for (var b = 0; b < e.stChildren.length; b++) {
        ...
        OrgChart.manager._iterate(t, e.stChildren[b], r, 0, a, n, o, l, O, h, d, c)
    }
    i++;
...
OrgChart.manager.__createNodes = function(t, e, r, i, a, n, o, l) {
    ...
    for (d = 0; d < s.length; d++) {
        ...
        b) {
            var v = n ? n[b.id] : null;
            v && (b.min = v.min),
            b.stChildrenIds.push(f.id)
        } else
            O ? (C && (f.collapsed = C.collapsed,
            f.min = C.min),
            O.childrenIds.push(f.id)) : (C && (f.collapsed = C.collapsed,
            f.min = C.min),
            e.push(f),
            o.push(f.id));
...
OrgChart.manager._createNodes = function(t) {
            ...
            if (c) {
                ...
                if (!u) {
                    if (!OrgChart.isNEU(c.pid))
                        (j = (O = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && O.childrenIds.splice(j, 1);
                    s.push(c)
                }
            }
        }
    ...
    for (d = 0; d < I.length; d++) {
        ...
        for (x = 0; x < C.children.length; x++) {
            (D = C.children[x]).isAssistant ? A.push(D.id) : -1 != D.tags.indexOf("right-partner") ? (D.isPartner = 1,
            D.children = [],
            E.push(D.id)) : -1 != D.tags.indexOf("left-partner") ? (D.isPartner = 2,
            D.children = [],
            N.push(D.id)) : -1 == D.tags.indexOf("partner") || M % 2 ? -1 != D.tags.indexOf("partner") && M % 2 ? (D.isPartner = 2,
            D.children = [],
            N.push(D.id),
            M++) : D.parentPartner ? (L[D.parentPartner.id] || (L[D.parentPartner.id] = []),
            L[D.parentPartner.id].push(D.id)) : A.push(D.id) : (D.isPartner = 1,
            D.children = [],
            E.push(D.id),
            M++)
        }
        ...
        for (x = 0; x < R.length; x++) {
            (D = l[R[x]]).collapsed || (D.parentPartner = D.parent,
            D.parent = C,
        ...
        for (x = 0; x < F.length; x++) {
            (D = l[F[x]]).collapsed || (D.parentPartner = D.parent,
            D.parent = C,
            D.isChildOfPartner = !0,
            C.children.push(D))
        }
        C.partnerSeparation = Math.max(P.length, U.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation,
        A.length || !T || B ? A.length || T || !B ? A.length || 1 != T || 1 != B ? A.length || T || B ? !A.length || T || B ? A.length && (T || B) ? C.hasPartners = 7 : C.hasPartners = 1 : C.hasPartners = 6 : C.hasPartners = 5 : C.hasPartners = 4 : C.hasPartners = 3 : C.hasPartners = 2
    }
    for (d = 0; d < k.length; d++) {
        if ((at = r[(C = l[k[d]]).lcn ? C.lcn : "base"]).layout == OrgChart.layout.normal || !S[C.pid])
            for (x = 0; x < C.subLevels; x++) {
                var j, z = new OrgChart.node(C.id + "_sub_level_index_" + x,C.pid,[],"subLevel");
                if (OrgChart.manager._initDinamicNode(z, C.lcn),
                O = C.parent)
                    (j = O.children.indexOf(C)) > -1 && (O.children.splice(j, 1),
    ...
    for (var Y in w) {
        ...
        for (x = O.children.length - 1; x >= 0; x--) {
            (D = O.children[x]).isAssistant ? (D.parent = null,
            O.children.splice(x, 1),
            X.splice(0, 0, D.id)) : D.isPartner || (D.parent && S[D.parent.id] && z && D.parent.id != z.id && (Object.defineProperty(S, z.id, Object.getOwnPropertyDescriptor(S, D.parent.id)),
            ...
            if ((at = r[O.lcn ? O.lcn : "base"]).layout > 0 || et)
                ...
                rt.layout == OrgChart.layout.mixed) {
                    ...
                    for (d = rt.childrenIds.length - 1; d >= 0; d--) {
                        for (D = l[rt.childrenIds[d]],
                        x = 0; x < O.children.length; x++)
                            O.children[x].id == D.id && O.children.splice(x, 1);
                        if (D.parent = null,
                        D.layout = rt.layout,
                        rt.layout != OrgChart.layout.treeRightOffset && rt.layout != OrgChart.layout.treeRight || lt.splice(0, 0, D.id),
                        rt.layout > 2) {
    ...
    return OrgChart.events.publish("nodes-initialized", [t, rt]),
    {
        nodes: rt.nodes,
        roots: rt.roots,
        rootList: h
...
OrgChart.manager._getResponse = function(t, e, r, i, a, n, o, l, s, h, d, c, g, p, u) {
    ...
    0 == h.length || null == s && !u && i.align == OrgChart.CENTER) {
        ...
        if (y - 2 * i.padding >= a - o)
            ...
            switch (w = f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2,
            i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
...
OrgChart.manager._iterate2 = function(t, e, r, i, a, n, o, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        null != d && null != d.x && null != d.y && (d.x == t.x && d.y == t.y || (h[0].push(t.id),
        h[1].push({
...
OrgChart.templates.base = {
    ...
    svg: '<svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="setBg" style="display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
...
OrgChart.templates.ana = {
    ...
    expandCollapseSize: 30,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="allTemplateSetBg"  style="display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
...
OrgChart.templates.rony.svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="ronySetBg" style="background-color:#E8E8E8;display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
...
OrgChart.templates.luba.defs = '<linearGradient id="{randId}" class="" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" style="stop-color:#646464;stop-opacity:1" /><stop offset="100%" style="stop-color:#363636;stop-opacity:1" /></linearGradient>',
    ...
    link: function(t, e, r, i, a, n) {
        ...
        if (t.hasPartners) {
            ...
            for (var f = 0; f < t.children.length; f++) {
                (m = t.children[f]).parentPartner ? (u.ppnodes[m.id] = m.parentPartner,
                u.ids.push(m.id),
                1 == m.parentPartner.isPartner ? (-1 == u.rightIds.indexOf(m.parentPartner.id) && u.rightIds.push(m.parentPartner.id),
                u.indexes[m.id] = u.rightIds.indexOf(m.parentPartner.id),
                u.firstRight || (u.firstRight = m)) : 2 == m.parentPartner.isPartner && (-1 == u.leftIds.indexOf(m.parentPartner.id) && u.leftIds.push(m.parentPartner.id),
                u.indexes[m.id] = u.leftIds.indexOf(m.parentPartner.id),
                u.lastLeft = m)) : m.isPartner || (u.lastLeft = m,
                u.firstRight || (u.firstRight = m))
            }
            u.maxSidePartnersWithChildren = Math.max(u.leftIds.length, u.rightIds.length),
            c = 0 == u.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + u.partnerChildrenSplitSeparation * u.maxSidePartnersWithChildren + u.partnerChildrenSplitSeparation / 2
        }
        for (f = 0; f < t.children.length; f++) {
            ...
            if (m.isChildOfPartner)
                ...
                else if ((y || m.layout > 1) && m.leftNeighbor && m.leftNeighbor.isSplit)
                    switch (l.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
            ...
            OrgChart.events.publish("render-link", [e, k]),
            h.push(k.html);
            var S = "";
            for (var I in e.config.linkBinding) {
                ...
                if (E) {
                    ...
                    k.element = s[I],
                    k.name = A,
                    !1 !== OrgChart.events.publish("label", [e, k]) && (OrgChart.isNEU(k.value) || OrgChart.isNEU(k.element) || (S += k.element.replace("{val}", k.value)))
                }
            }
            "" != S && (S = OrgChart.linkFieldsOpenTag.replace("{x}", b.x).replace("{y}", b.y).replace("{rotate}", 0) + S + OrgChart.grCloseTag,
            h.push(S)),
...
OrgChart.prototype._clink = function(t, e) {
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (d && -1 != e.res.visibleNodeIds.indexOf(d.id) && (c && -1 != e.res.visibleNodeIds.indexOf(c.id))) {
            ...
            l += ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", d.id).replace("{to}", c.id) + k.link.replaceAll("{d}", I) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + I + '" />',
...
OrgChart.prototype._slinks = function(t, e) {
    ...
    function n(e, n, o) {
        ...
        if (e.sl == n.sl)
            ...
            for (; null == h; ) {
                var b = !1
                  ...
                  , v = O.leftNeighbor
                  , x = O.rightNeighbor;
                if (O.id == n.id ? h = O : OrgChart._intersects(O, f, t.config) && (f = OrgChart._addPoint(O, s, t.config, f, d),
                b = !0),
                O.id != n.id) {
                    for (; v; ) {
                        if (v.id == n.id) {
                        ...
                        OrgChart._intersects(v, f, t.config) && (f = OrgChart._addPoint(v, s, t.config, f, d),
                        b = !0),
                        v = v.leftNeighbor
                    }
                    for (; x; ) {
                        ...
                        OrgChart._intersects(x, f, t.config) && (f = OrgChart._addPoint(x, s, t.config, f, d),
                        b = !0),
                        x = x.rightNeighbor
                    }
                }
        ...
        o && (U = n.id,
        P = e.id),
        r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", P) + p.link.replaceAll("{d}", L) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + L + '" />',
    ...
    if (this.instance.config.filterBy) {
        ...
        d.addEventListener("click", (function(t) {
            if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                for (var e = t.target.getAttribute("data-filter-field"), r = h.instance.element.querySelectorAll("[data-filter-menu]"), i = 0; i < r.length; i++)
                        ...
                        g[i].addEventListener("change", (function(t) {
                            ...
                            if (e) {
                                ...
                                if (t.target.hasAttribute("data-all")) {
                                    ...
                                    null != h.filterBy[r][this.name] && (h.filterBy[r][this.name].checked = this.checked);
                                h.instance.draw()
                            }
                        }
                        ))
